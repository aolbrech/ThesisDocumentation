...
\newcommand{\NegLLEvt}{-\ln(\mathcal{L}_{\textrm{MEM}})}
\newcommand{\DeltaChi}{\Delta \chi^{2}_{\textrm{MEM}}}
...
\newcommand{\MadEvent}{\texttt{MadEvent}}
...
\def\vecmetRaw{\mbox{$\vec{\eslash}_{T,raw}$}\xspace} %missing ET vector
