...
\subsection{Choice of the best jet combination}
...
\begin{figure}[h!t]
 \centering
 %\includegraphics[width = 0.45\textwidth]{Mlb.pdf}
 %\includegraphics[width = 0.45\textwidth]{Mqqb.pdf}
...
\begin{figure}[h!t]
 ...
 \includegraphics[width = 0.45 \textwidth]{Chapters/Chapter4_EvtSel/Figures/ChosenChiSqDistr_4vs5Jets_LogY.pdf}
...
\subsection{Additional event cleaning (based on kinematics)}\label{subsec::MassCuts}
Even though the application of a b-jet identification algorithm will significantly reduce the different background contributions, the reconstruction efficiency can still be improved further by excluding events using specific kinematic constraints, as will be shown here.
Especially since the Matrix Element method treats all events as it were semi-leptonical top-quark pair decays, ensuring the correct event topology to be reconstructed (for a large fraction of the events) will result in a clear improvement.
\\
For this reason it has been studied whether restricting the value of the $\chi^{2}$ corresponding to the chosen jet combination might possitively influence the reconstruction efficiency.
\\
\\
...
\\
\textbf{Mass cut is much more important so maybe better to first mention this!?}
\\
