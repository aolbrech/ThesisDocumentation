\chapter{Event selection and top-quark pair topology reconstruction} \label{ch::EvtSel}
...
Since for the trigger efficiencies an excellent agreement has been obtained between data and simulation~\cite{MuonPerf8TeV}, no correction factor will be applied to simulation. % to incorporate the possible minor differences in efficiency.
%****************************************
% Paper: TRG-12-001
...
The events considered in this analysis are required to contain exactly one such well-identified muon, with $\pT$ $>$ 26$\GeV$ and $\vert \eta \vert$ $<$ 2.1. Any event containing an additional lepton, either a PF muon reconstructed as global or tracker muon with $\pT$ $>$ 10$\GeV$, $\vert \eta \vert$ $<$ 2.5 and $I_{\textrm{rel}}^{\Delta \beta}$ $<$ 0.2 or otherwise an electron with $\pT$ $>$ 20$\GeV$, $\vert \eta \vert$ $<$ 2.5, $I_{\textrm{rel}}^{EA}$ $<$ 0.15 and $mvaId$ $>$ 0, are rejected. 
\\
...
Exploiting the presence of two jets originating from the decay of a b-quark in $\ttbar$ events is an effective manner of distinguishing the event topology from the background, since this type of decay has the peculiar feature that it gives rise to a displaced vertex. This because the relatively long lifetime of the B-mesons in b-quark decays implies that the decay does not occur at the interaction vertex, as has been explained in Section~\ref{subsec::jetReco}.
\\ 
...
\begin{figure}[h!t]
 \centering
 \includegraphics[width = 0.75 \textwidth]{Chapters/Chapter4_EvtSel/Figures/CSVDiscriminant.pdf}
...
From the collection of light jets only the two expected to originate from the hadronical decaying W-boson have to be identified, but not matched with a specific jet since the up- and down-type jet are impossible to be distinguished. %Hence the recovered event topology will have two possible permutations, which both have to be considered.
\\
\\
...
The benefit of using the $m_{lb}$ variable instead of determining the invariant mass of the full leptonic decaying top-quark system is that the reconstruction of the neutrino can be avoided.
...
\begin{figure}[h!t]
 \centering
 \includegraphics[width = 0.47\textwidth]{Chapters/Chapter4_EvtSel/Figures/Mlb_CorrTT.pdf} \hspace{0.2cm} %Mlb here
 \includegraphics[width = 0.47\textwidth]{Chapters/Chapter4_EvtSel/Figures/HadrMTop_CorrTT.pdf} %Mqqb here
...
\begin{figure}[h!t]
 ...
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/WrongChiSqComparison.pdf}    %Put here the same but for wrong chisqs (normalised to have comparable numbers!) 
...
\begin{figure}[h!t]
 \centering
 \includegraphics[width = 0.68 \textwidth]{Chapters/Chapter4_EvtSel/Figures/MWComparison.pdf}
 %\includegraphics[width = 0.48 \textwidth]{Chapters/Chapter4_EvtSel/Figures/MTComparison.pdf}
...
\begin{figure}[h!t]
 \centering
 \includegraphics[width = 0.68 \textwidth]{Chapters/Chapter4_EvtSel/Figures/HadrMW_CorrTT.pdf}  %Put here the MW mass distribution (but do not make it too large ...)
...
\section{Influence of full event selection} \label{sec::DataMC} %Kinematics of remaining events/Finalized event selection} 
...
Once all necessary calibrations have been included the actual comparison between data and simulation can be performed at a luminosity of 19.6 $\pm$ 0.5$\fbinv$, which is the amount of data collected by the considered isolated-muon triggers during the 2012 data-taking period.
...
\begin{figure}[h!tp]
 \centering
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/MlbMqqbChiSq_mu_Stack.pdf} \vspace{0.3cm} \\
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/HadrTopMass_mu_Stack.pdf} \hspace{0.2cm}
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/HadrWMass_mu_Stack.pdf} 
...
\begin{figure}[h!tp]
 \centering
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/HadrB_JetPt_mu_Stack.pdf} \hspace{0.2cm}
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/HadrB_JetEta_mu_Stack.pdf}  \vspace{0.3cm} \\
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/LeptB_JetPt_mu_Stack.pdf} \hspace{0.2cm}
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/LeptB_JetEta_mu_Stack.pdf}
...
\begin{figure}[h!tp]
 \centering
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/Light1_JetPt_mu_Stack.pdf}  \hspace{0.2cm}
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/Light1_JetEta_mu_Stack.pdf} \vspace{0.3cm} \\
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/Light2_JetPt_mu_Stack.pdf}  \hspace{0.2cm}
 \includegraphics[width = 0.47 \textwidth]{Chapters/Chapter4_EvtSel/Figures/Light2_JetEta_mu_Stack.pdf}
