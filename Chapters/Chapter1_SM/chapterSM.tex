...
A common strategy adopted in spin correlations studies is in stead of measuring the spin correlation strength to determine the degree of spin correlation relative to the SM prediciton $f_{SM}$. 
...
Of all the properties discussed before, the measurement of the anomalous couplings of the $Wtb$ interaction vertex is closest related to the determination of the W-boson helicity fraction. They both try to explain whether this weak interaction is purely governed by left-handed particles, as predicted by the Standard Model.