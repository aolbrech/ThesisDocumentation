...
The first one is the TOTEM~\cite{} %(Total elastic and diffractive cross section measurement) 
experiment, which is placed close to the CMS detector along the beampipe and is designed to investigate the proton structure\footnote{Definitely certain that 'structure' is good to be used??} in the very forward region. The LHCf~\cite{} %(Large Hadron Collider forward) 
...
The last experiment, MOEDAL~\cite{} % or Monopole and exotics detector at the LHC,
